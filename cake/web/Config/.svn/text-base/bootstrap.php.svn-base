 ...
 */
CakePlugin::load(array(
	'FishSayingApi' => array('bootstrap' => array(
		'bootstrap'
	))
));
/**
...
/**
 * Configures download links for app
 */
Configure::write('Download.ios','https://itunes.apple.com/cn/app/fishsaying/id747780955?ls=1&mt=8');
Configure::write('Download.android','http://fsapp.joyotime.com/FishSaying.apk');

Configure::write('Api.PK', 'DYhG93b0qyJfIxfs2guVoUubbwvniR2G0FgaC9mi');
Configure::write('Api.Domain', "http://staging.api.fishsaying.com");
