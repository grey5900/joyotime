            ...
            <ul class="nav nav-tabs">
                <li >
                    <div class="nav-tab-active">
                       <a href="<?php echo $this->Voice->listLink(Voice::AD_STATUS); ?>"><?php echo __('广告列表') ?></a>
                    </div>
                </li>
                <li class="active">
                    <div class="nav-tab-active">
                       <a href="<?php echo $this->Voice->listLink(Voice::AD_ADD); ?>"><?php echo __('新增广告') ?></a>
                    </div>
                </li>
            </ul>
            <form class="navbar-form navbar-right" name="search" action="/voices/index/7" method="get">
