...
// $config['mod_c_path'] = FCPATH . 'static/template/place';
// 这里改成绝对地址了。因为要更新到网站去
$config['mod_c_path'] = '/var/www/html/juno-3.0/template/i_place';
...
// 14             网页 ITEM_TYPE_WEB                                      http://in.chengdu.cn/user/10001// 连接类型
// 15             会员卡 ITEM_TYPE_MCARD                                      inmcard://in.chengdu.cn/10001// 连接类型
...
/*$config['ftp_serv'] = array(
	1=>array(
		'server' => 'http://pic1.in.chengdu.cn',//FTP地址
		'user' => 'user', //FTP账号
	...
	2=>array(
		'server' => 'http://pic1.in.chengdu.cn',
		'user' => 'user',
		'password' => 'password',
		'port' => 23,//FTP上传端口
		'debug' => true//上线时改成FALSE
