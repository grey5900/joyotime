...
(function( $, window, undefined ) {
	...
	$.mobile = $.extend($.mobile, {
		...
		// data-attrs 设置空间名. 默认没有空间名
		ns: "",
        
        // 使用widget-generated sub-pages 定义url参数
		// Define the url parameter used for referencing widget-generated sub-pages.
		//定义url参数用于引用小部件生成的子页面。
		// Translates to to example.html&ui-page=subpageIdentifier
		// hash segment before &ui-page= is used to make Ajax request使Ajax请求
...
//auto self-init widgets   绑定在pagecreate里面
...
$.mobile.listview.prototype.options.filterTheme = "icd";
