...
$label.css(altBoxCss('#000000'));
if($this.val())$label.hide();}
$this.focus(function(){
getAltBox().css(altBoxCss('#999999'));}).blur(function(){
if(!$(this).val())getAltBox().show().css("color","#000000");}).keydown(function(){
getAltBox().hide();});});},
isTag:function(tn){
if(!tn)return false;
