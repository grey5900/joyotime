...
(function($) {
    ...
    (function() {
        ...
        Tags.Templates["3"].tag = function(options) {
            ...
            return "<div class='tag label " + options.tagClass + " " + options.tagSize + "' " + (options.isPopover ? "rel='popover'" : "") + ">    <span>" + Tags.Helpers.addPadding(options.tag, 2, options.isReadOnly) + "</span>    " + (options.isReadOnly ? "" : "<a style='font-size: 20px;color:#fff;line-height:12px;height:12px;display:inline-block;vertical-align: top;'>×</a>") + "  </div>";
        };
    }).call(this);
    (function() {
        var _base;
