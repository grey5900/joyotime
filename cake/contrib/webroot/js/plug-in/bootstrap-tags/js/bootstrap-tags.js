...
(function($) {
    ...
    (function() {
        ...
        Tags.Templates["3"].tag = function(options) {
            ...
            return "<div class='tag label " + options.tagClass + " " + options.tagSize + "' " + (options.isPopover ? "rel='popover'" : "") + ">    <span>" + Tags.Helpers.addPadding(options.tag, 2, options.isReadOnly) + "</span>    " + (options.isReadOnly ? "" : "<a style='font-size: 18px;color:#fff;height:15px;line-height: 15px;display: inline-block;vertical-align: middle;'>×</a>") + "  </div>";
        };
    }).call(this);
    (function() {
        var _base;
