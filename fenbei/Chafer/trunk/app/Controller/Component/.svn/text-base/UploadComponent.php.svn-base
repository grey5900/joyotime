...
class UploadComponent extends Component
{
    ...
    public function __construct(ComponentCollection $collection, $settings = array()) {
        ...
        if (isset($settings['error_messages']) && !empty($settings['error_messages'])) {
            $this->error_messages = array_merge($this->error_messages, $settings['error_messages']);
        }
//         $settings['initialize'] = !isset($settings['initialize']) ? TRUE : $settings['initialize'];
//         // To set $settings['initialize'] is true if no found.
//         if (!isset($settings['initialize'])) {
//             $this->initialize($collection->getController());
//         }
    }
