<div class="page-wrapper">
    <div class="tab-content clearfix active">
         <div class="box-navtool">
            ...
            <form class="navbar-form navbar-right" name="search" action="/users/agencyAuthAdd" method="get">
        ...
        <table class="table table-condensed">
            ...
            <?php foreach($items as $idx => $row): ?>
                ...
                <tr class="radius">
                    ...
                    <td>
                      <?php echo $this->User->agencyAuthLink() ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
...
$(function() {
    ...
    function submit_search(){
        ...
        window.location.href = "/users/agencyAuthAdd/" + username;
    }
