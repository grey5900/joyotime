...
class My_Order extends MY_Controller {
    ...
    private function _list($is_payed) {
        ...
        $where_sql = 'gi.id = o.itemId AND o.itemType = 12 AND gi.sourceType = 2 AND o.uid = u.id AND o.isPayed = ' . $is_payed;
        ...
        $total_num = $this->db->where($where_sql)->from('OrderInfo o, User u, GrouponItem gi')->count_all_results();
