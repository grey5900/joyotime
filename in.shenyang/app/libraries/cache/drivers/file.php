...
class FileCache implements ICache {
    ...
    function & getInstance($options) {
        return self::$_cache ? self::$_cache : self::$_cache = new FileCache($options);
    }
    ...
    function set($key, $value, $expire = 0) {
        $this->_cache_lite->setLifeTime($expire);
        $this->_cache_lite->save($value, $key);
    }
     ...
     */
    function get($key) {
        return $this->_cache_lite->get($key);
    }
