...
<div class="control-group">
	...
	<div class="controls box-fileupload">
		<div class="fileupload-operate">
  		...
  		<span class="fileupload-info">建议640*320以上，jpg, jpeg, png格式</span>
...
<?php
$this->start('script');
echo $this->Html->script('blueimp/jquery.fileupload');
echo $this->Html->script('blueimp/jquery.fileupload-process.min');
echo $this->Html->script('blueimp/jquery.fileupload-validate.min');
echo $this->Html->script('blueimp/jquery.iframe-transport.min');
echo $this->Html->script('fenpay.fileupload.min');
$this->end();
?>