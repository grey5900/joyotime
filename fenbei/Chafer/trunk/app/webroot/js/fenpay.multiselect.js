...
!function ($) {
    ...
    function Multiselect(select, options) {
        ...
        this.$container = $(this.options.buttonContainer)
            ...
            .append('<div class="multiselect-container"><ul class="box-checkbox" style="list-style-type: none;margin:0;padding:0;"></ul></div>');
        ...
        if (this.options.enableFiltering) {
            $('.multiselect-container', this.$container).prepend('<div class="input-prepend" style="padding:10px 0 5px;"><span class="add-on" style="padding:1px 4px;"><i class="icon-search"></i></span><input class="multiselect-search" type="text" placeholder="' + this.options.filterPlaceholder + '"></div>');
    ...
    Multiselect.prototype = {
        ...
        createOptionValue: function(element) {
            ...
            var $li = $('<li><a href="javascript:void(0);" style="padding:0;"><label style="margin:0;padding:3px 20px 3px 20px;height:100%;cursor:pointer;color:#666;"><input style="margin-bottom:5px;" type="' + inputType + '" /></label></a></li>');
