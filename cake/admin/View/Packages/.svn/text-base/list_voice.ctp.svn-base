...
<?php endif; ?>
            ...
            <form class="navbar-form navbar-right" name="search" action="/packages/relationVoice/<?php echo $package['_id'];?>/2" method="get">
        ...
        <table class="table table-condensed">
            ...
            <?php foreach($items as $idx => $row): ?>
                ...
                <tr class="">
                    ...
                    <td><?php echo $this->Voice->tags() ?></td>
                    <td><?php echo $this->Packages->pushVoiceLink($this->Voice->id(),$package['_id'],$voice_ids); ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>    
...
// 	var linkRemove = '';
    ...
    $('a.push-voice-link').click(function(){
	    var $this = $(this);
