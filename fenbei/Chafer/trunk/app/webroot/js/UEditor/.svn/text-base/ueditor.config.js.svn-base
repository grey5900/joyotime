...
//        ,imageUrl:URL+"php/imageUp.php"             //图片上传提交地址
        ,imageUrl:"/upload/figure"             //图片上传提交地址
        ,imagePath:"http://wx.joyotime.com"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,imageManagerPath:"http://"                                    //图片修正地址，同imagePath
        ...
        , toolbars:[
            // ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                ['fontsize','fontfamily','bold','italic','underline','forecolor','backcolor','insertorderedlist','insertunorderedlist',
                'justifycenter','justifyleft','justifyright','insertimage','link','emotion','removeformat','source']
        ]
