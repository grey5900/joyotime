...
// 
    ...
    public $default = array(
		...
		'host' => '',
		'database' => 'fishsaying_admin_logs',
		'port' => null,
		'prefix' => '',
		'persistent' => 'true',
		'login' => '',
    ...
    // 		'database' => 'fishsaying_9_28',
    		...
    		'password' => '',
    		'replicaset' => array(
    				'host' => 'mongodb://127.0.0.1:10001',
    				'options' => array('replicaSet' => 'rs')
    		)
    );
    //合作商数据库
    public $fishsaying_partner = array(
    		'datasource' => 'Mongodb.MongodbSource',
    		'host' => '',
    		'database' => 'fishsaying_partner',
    		'port' => null,
    		'prefix' => '',
    		'persistent' => 'true',
    		'login' => '',
