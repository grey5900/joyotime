    ...
    $.tags = function(element, options) {
      ...
      this.formatTag = function(i, tag) {
        ...
        if (_this.displayPopovers === true) {
          ...
          return "<div class='tag label " + _this.tagClass + "' rel='popover' data-placement='bottom' data-content='" + popoverContent + "' data-original-title='" + tag + "'><span>" + tag + "</span><a> <i class='icon-remove'></i></a></div>";
        } else {
          return "<div class='tag label " + _this.tagClass + "'><span>" + tag + "</span><a> <i class='icon-remove'></i></a></div>";
        }
      };
