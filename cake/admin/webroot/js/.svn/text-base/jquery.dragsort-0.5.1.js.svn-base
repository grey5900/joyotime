...
$.browsermozilla = /firefox/.test(navigator.userAgent.toLowerCase());
...
$.browsersafari= /webkit/.test(navigator.userAgent.toLowerCase());
(function($) {
			...
			var newList = {
				...
				setPos: function(x, y) { 
					...
					this.draggedItem.parents().each(function() {
						if ($(this).css("position") != "static" && (!$.browsermozilla || $(this).css("display") != "table")) {
				...
				wheel: function(e) {
					if (($.browsersafari || $.browsermozilla) && list && opts.scrollContainer != window) {
						var cont = $(opts.scrollContainer);
						var offset = cont.offset();
