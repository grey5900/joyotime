...
<html lang="en">
    <head>
        ...
        <title><?php echo __('解说录制指南'); ?></title>
        ...
        <div class="container">
            <div class="box">
                ...
                <div class="typo text-article">
                    ...
                    <div class="content">
                        <p>
                            <?php echo __('受欢迎的解说往往富有自己的特色，让听过的游客都有所收获'); ?>
                        </p>
                    </div>
                </div>
                <div class="typo text-article">
                    ...
                    <div class="content">
                        <p>
                            <?php echo __('前30秒为免费试听，游客会根据这段时间的内容质量来判断解说是否值得购买'); ?>
                        </p>
                    </div>
                </div>
                <div class="typo text-article">
                    <div class="title"><h3><?php echo __('图片是解说的门面'); ?></h3></div>
                    <div class="content">
                        <p>
                ...
                <div class="typo text-article">
                    ...
                    <div class="content">
                        <p>
                            <?php echo __('游客主要通过定位来寻找当地的解说，距离更近的解说会排在更前面'); ?>
                        </p>
                    </div>
                </div>
                <div class="typo text-article">
                ...
                <div class="typo text-article">
                    ...
                    <div class="content">
                        <p>
                            <?php echo __('为保障解说质量，通过鱼说管理员审核的解说才能上架销售'); ?>
                        </p>
                    </div>
                </div>
                <div class="typo text-article">
            ...
            <div class="box">
            	<div class="typo text-title ">
            		<h3><em>1.</em><?php echo __('解说上架规范'); ?></h3>
            		<ul>
            			...
            			<li><em>1.9</em><div><?php echo __('不得重复发布同一条解说或雷同解说;'); ?></div></li>
            	...
            	<div class="typo text-title">
            		...
            		<ul>
            			<li><em>2.1</em><div><?php echo __('提交的解说经审核通过后立即上架;'); ?></div></li>
            			<li><em>2.2</em><div><?php echo __('若提交的解说被驳回，可修改后再次提交审核;'); ?></div></li>
            			<li><em>2.3</em><div><?php echo __('已上架的解说原则上不能修改和删除，也不能自主下架，如遇特殊情况需要下架，请通过举报功能请求下架并说明下架原因;'); ?></div></li>
            			<li><em>2.4</em><div><?php echo __('若已上架的解说被用户举报，经调查核实后，违规的解说将会被下架，被下架的解说不能再次上架;'); ?></div></li>
            		</ul>
            	</div>
            	<div class="typo text-title">
            	    <h3><em>3.</em><?php echo __('定价方式'); ?></h3>
            	    <ul>
            	    	<li><em>3.1</em><div><?php echo __("以时间为虚拟货币单位，按照解说实际时长定价;"); ?></div></li>
            	    	<li><em>3.2</em><div><?php echo __("买家可免费试听前30秒，但购买时需为整段付费;"); ?></div></li>
            	    </ul>
            	</div>
            	<div class="typo text-title">
            	    <h3><em>4.</em><?php echo __('收入分配'); ?></h3>
            	    <ul>
            	    	<li><em>4.1</em><div><?php echo __('除去用户充值时的支付平台抽成（30%）和鱼说抽成（30%），提现的实际价格为￥0.15/分钟；'); ?></div></li>
            	    	<li><em>4.2</em><div><?php echo __('所得收入可用于购买解说，也可以折算成现金提现至个人账户中；'); ?></div></li>
            	    	<li><em>4.3</em><div><?php echo __('解说收入高于20分钟才能申请提现;'); ?></div></li>
            	    	<li><em>4.4</em><div><?php echo __('提现过程中支付平台可能会向您收取一部分手续费;'); ?></div></li>
            	    </ul>
            	</div>
            	<div class="typo text-title">
            	    <h3><em>5.</em><?php echo __('版权声明'); ?></h3>
            	    <ul>
            	    	<li><em>5.1</em><div><?php echo __('鱼说仅为内容存储和交易平台，无须对用户发布的任何内容承担任何责任;'); ?></div></li>
            	    	<li><em>5.2</em><div><?php echo __('在鱼说上传或发布的任何内容版权均归发布者所有，受到著作权和知识产权相关法律的保护;'); ?></div></li>
            	    	<li><em>5.3</em><div><?php echo __('若您的著作权或知识产权遭到侵害，可以联系鱼说要求删除侵权内容;'); ?></div></li>
            	    	<li><em>5.4</em><div><?php echo __('若您发布的内容对他人的著作权或知识产权造成了侵害，鱼说将按照有关法律规定，删除侵权内容甚至终止您对账户的使用;'); ?></div></li>
            	    </ul>
            	</div>
