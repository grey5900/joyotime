...
/**
 * The model of auto replay keyword.
 * The keywords just for fixcode message.
 *
 * @package       app.Model
 */
class AutoReplyKeyword extends AppModel {
    
    public $name = 'AutoReplyKeyword';
    
    public $hasAndBelongsToMany = array(
        'AutoReplyFixcode' => array(
            'className' => 'AutoReplyFixcode',
            'joinTable' => 'auto_reply_fixcode_keywords',
            'foreignKey' => 'auto_reply_keyword_id',
            'associationForeignKey' => 'auto_reply_fixcode_id',
            'unique' => true 
        ) 
    );
