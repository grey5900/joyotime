    		...
    		case 'post'://点评、签到、图片
    			...
    			foreach($query as $row){
    				$data = array(
    					...
    					'intro'=>$row['content'],
    					'image'=>$row['photoName'],
    					'title_link'=>'http://in.chengdu.cn/review/'.$row['id'],
    		...
    		case 'user'://用户，忽略FID
    			...
    			foreach($query as $row){
    				$data = array(
    					'id'=>$row['id'],
    					'title'=>$row['username'],
    					'title_link'=>'http://in.chengdu.cn/user/'.$row['id'],
    		...
    		case 'place'://地点
    			...
    			foreach($query as $row){
    				$datas[] = array(
    					...
    					'title'=>$row['placename'],
    					'intro'=>$row['address'],
    					'title_link'=>'http://in.chengdu.cn/place/'.$row['id']
    				);
    			}
    			unset($query);
    			break;
    		case 'event'://活动
    			...
    			foreach($query as $row){
    				$datas[] = array(
    					...
    					'title_link' => 'http://in.chengdu.cn/event/index/'.$row['id']
    				);
    			}
    			unset($query);
    			break;
