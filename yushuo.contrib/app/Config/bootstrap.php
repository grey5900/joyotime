 ...
 */
Configure::write('Path.Vendor', ROOT.DS.APP_DIR.DS.'Vendor'.DS);
Configure::write('Path.QiNiu',  ROOT.DS.APP_DIR.DS.'Vendor'.DS.'qiniu'.DS.'qiniu'.DS);
/**
 * Configure information about QiNiu.com
 */
Configure::write('QINIU_UP_HOST', 'http://up.qiniu.com');
/**
 * Configure path of ffmpeg bin file 
 */
Configure::write('FFMPEG_BIN_PATH', '/opt/ffmpeg_build/bin/ffmpeg');