...
<?php endif; ?>
            ...
            <form class="navbar-form navbar-right" name="search" action="/voices/index/5" method="get">
        ...
        <table class="table table-condensed">
            ...
            <?php foreach($items as $idx => $row): ?>
                ...
                <tr class="">
                    ...
                    <td><?php echo $this->Voice->tagTotal(5) ?></td>
                    <td><?php echo $this->Voice->recommendLink(); ?></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
        </table>    
...
$(function() {
    ...
    $('a.recommend-voice-link').click(function(){
	    var $this = $(this);
