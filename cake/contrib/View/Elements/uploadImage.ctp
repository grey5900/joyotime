<div class="control-group">
	...
	<div class="controls box-fileupload">
		<div class="fileupload fileupload-new" data-provides="fileupload">
          <div id="uploadButtonHide">
          	<span class="btn btn-primary btn-file">
          	  ...
          	  <input type="file" accept="image/*" name="cover" class="input-stand" required="required" id="imageCover">
        ...
        <input type="hidden" name="data[voices][cover]" id="voicesCover" value />
