            ...
            <ul class="nav nav-tabs">
               <li class="active">
                    <div class="nav-tab-active">
                        <a href="/users/agencyAuth"><?php echo __('认证机构列表') ?></a>
                    </div>
                </li>
                <li >
                    <div class="nav-tab-active">
                        <a href="/users/agencyAuthAdd"><?php echo __('新增认证') ?></a>
                    </div>
                </li>
            </ul>
            <form class="navbar-form navbar-right" name="search" action="/users/agencyAuth" method="get">
        ...
        <table class="table table-condensed">
            <thead>
                <?php 
                    echo $this->Html->tableHeaders(array(
						...
						array(__('广告') => array('width' => '6%')),
                        array(__('剩于次数') => array('width' => '10%')), 
            ...
            <?php foreach($items as $idx => $row): ?>
                ...
                <tr class="radius">
                    ...
                    <td><?php echo $this->User->earn() ?></td>
                  <td>
                    <?php echo $this->User->rechargeLink() ?><br />
                    <?php echo $this->User->agencyAuthInfoEditLink() ?><br />
                      <?php echo $this->User->agencyAuthCancelLink() ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
...
<?php echo $this->element('/modals/user/recharge'); ?>
...
$(function() {
    ...
    $('#user-modal button.btn-primary').click(function(){
    ...
    function submit_search(){
        ...
        window.location.href = "/users/agencyAuth/" + username;
    }
