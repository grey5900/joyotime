...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //屏幕截图配置区
        ,snapscreenHost: '127.0.0.1'//location.hostname                                 //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
...
//        }
        ...
        ,initialStyle:'body{line-height:2em}'//编辑器层级的基数,可以用来改变字体等
